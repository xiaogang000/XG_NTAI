...
public class JspEncodeDemo5 {
    ...
    public JspEncodeDemo5() {
    }

    public JspEncodeDemo5(String tamplate, String key, String code) {
        ...
        if(!sourcecode.isEmpty()){
            try {
                if(this.key.equals("默认随机")){
                    this.key = "b"+RandomString.getRString(5);
                }
